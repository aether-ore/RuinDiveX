...
export const REAVERBOT_BOSS_PROFILES = deepFreeze([
  ...
  profile({
    ...
    phaseOne: ['erraticFlit', 'mineScatter', 'detonatorSummon', 'reliquaryRaid'],
    phaseTwo: ['detonatorShield', 'shieldedRaid', 'acceleratedDetonatorSummon'],
    overloadWeakening: 'detonatorShieldBreakCreatesDamageWindow',
    arena: { mechanicId: 'redirectedDetonatorShield', anchorKinds: ['mineField', 'raidBlast', 'detonatorMinion'] },
    healthScale: 7.5,
  }),
]);
