...
export const REAVERBOT_ARCHETYPES = Object.freeze({
  ...
  packHunter: {
    ...
    behavior: {
      ...
      recovery: 0.68,
      turnRate: 4.8,
      flankApproachDistance: 1.9,
      flankRearBiasMin: 0.28,
      flankRearBiasMax: 0.78,
      flankAttackDot: 0.2,
      flankPursuitSpeedScale: 1.28,
      attackCooldownScale: 0.22,
      attackCooldownFloor: 0.32,
      forcedAttackSeconds: 15,
    },
    threatCost: 4,
  },
  duelist: {
...
export const REAVERBOT_WEAPONS = Object.freeze({
  ...
  clawArm: {
    ...
    telegraphDuration: 1.65, commitDuration: 0.58, horizontalCommitDuration: 0.52, slamCommitDuration: 0.58,
